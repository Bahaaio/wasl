...
export default function CreateCommunityPage() {
  ...
  const handleNext = () => {
    if (step === 1 && !canContinueStepOne) {
      setFormError("Choose a valid community name and description first.");
      return;
    }
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="mb-8">
              ...
              <p className="mt-3 max-w-2xl text-slate-400 leading-relaxed">
                Set up a community with the same flow Reddit uses: name it,
                define the rules, choose who can participate, and preview it
                before you launch.
              </p>
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-slate-300 max-w-xl">
                      Your community shell has been created locally. Hook it to
                      the backend next, and this same screen can submit the real
                      API payload.
                    </p>
