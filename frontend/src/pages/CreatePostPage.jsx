          ...
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
                type="button"
                onClick={() => navigate(-1)}
                className="rounded-full border border-slate-700/50 bg-slate-800/50 p-2.5 text-slate-400 transition-all duration-300 hover:border-orange-500/50 hover:bg-linear-to-br hover:from-orange-500/30 hover:to-red-600/30 hover:text-orange-400 hover:shadow-lg hover:shadow-orange-500/20"
                aria-label="Go back"
              >
            ...
            <button
              ...
              className="text-sm font-medium text-slate-400 transition-colors hover:text-slate-300"
            >
              Drafts
            </button>
          </div>
                    ...
                    {isLoadingCommunities || isSearchingCommunities ? (
                      ...
                      filteredCommunities.map(community => {
                        return (
                          ...
                          >
                            <span>
                              {toDisplayCommunityName(community.name)}
                            </span>
